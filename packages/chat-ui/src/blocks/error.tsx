...
export function ErrorBlock({ code, message }: { code: string; message: string }) {
  return (
    <div role="alert" className="nova-error-block flex items-start gap-2.5 rounded-xl bg-rose-50 px-3 py-2.5 text-rose-800 ring-1 ring-rose-200/80 dark:bg-rose-950/30 dark:text-rose-300 dark:ring-rose-900">
