...
```bash
pnpm add @nova/runner
npx nova-runner --server http://127.0.0.1:50051 --token <runner-token> --workspace ./project
```
...
```bash
NOVA_RUNNER_BIN=/path/to/nova-runner npx nova-runner --help
```
